<div id="header" class="row">
    <div class="container">
        ...
        <div class="row padding-top-20 padding-bottom-20">
            <div class="col l1-3 m1-3 s12 padding-top-20 no-mobile">
                <div class="box bs">
                    <ul class="social">
            ...
            <div class="col l1-3 m1-3 s8 logo align-center">
                <div class="box bs">
                    <h1><a href="/" title="LOGO">GRID <?php echo $_GET['grid']; ?></a></h1>
                </div>
            </div>
        </div>
        <div id="nav" class="row">
            <div class="col l16 m16 s16">
                <div class="box bs">
                    <nav>
                        <ul>
            ...
            <div class="col l1-3 m1-3 s16 mobile-only">
                <div class="box bs">
                    <ul class="social">
                        <li><a href="#" title="twitter"><i class="fa fa-twitter"></i></a></li>
                        <li><a href="#" title="facebook"><i class="fa fa-facebook-f"></i></a></li>
